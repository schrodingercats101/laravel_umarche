                            ...
                            <table class="table-auto w-full text-left whitespace-no-wrap">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td class="px-4 py-3">
                                      <button onclick="location.href='{{ route('admin.owners.edit',['owner' => $owner->id]) }}'" class="flex mx-auto text-white bg-purple-500 border-0 py-2 px-4 focus:outline-none hover:bg-purple-500 rounded ">編集</button>
                                    </td>
